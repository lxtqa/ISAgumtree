...
@Register(name = "textmatch", description = "Dump actions in a textual format.",
        options = TextMatch.TextMatchOptions.class)
public class TextMatch extends AbstractDiffClient<TextMatch.TextMatchOptions> {
    public TextMatch(String[] args) {
        super(args);
    ...
    public static class TextMatchOptions extends AbstractDiffClient.DiffOptions {
    ...
    @Override
    protected TextMatchOptions newOptions() {
        return new TextMatchOptions();
    }
